...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProfileSendRequest = (Button) findViewById(R.id.profile_button);
                            ...
                            if(task.isSuccessful()){
                                ...
                                .setValue("received").addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        Toast.makeText(ProfileActivity.this, "Success in sending request", Toast.LENGTH_LONG).show();
                                }
                                });
                            }else{
                                Toast.makeText(ProfileActivity.this, "Failed in sending request", Toast.LENGTH_LONG).show();
                            }
                        }
                    });
                }
